...
const EditSweetModal = ({ show, sweet, onClose, onSubmit }) => {
    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            onClick={onClose}
            className="p-1 rounded-full cursor-pointer text-gray-400 hover:bg-gray-100 hover:text-gray-600 transition duration-200"
          >
            <svg
              className="w-5 h-5"
              fill="none"
